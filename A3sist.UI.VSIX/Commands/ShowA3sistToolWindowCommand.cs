...
namespace A3sist.UI.VSIX.Commands
{
    /// <summary>
    ...
    internal sealed class ShowA3sistToolWindowCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowA3sistToolWindowCommand"/> class.
        ...
        /// </summary>
        public static ShowA3sistToolWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in ShowA3sistToolWindowCommand's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(A3sistToolWindow), 0, true, this.package.DisposalToken);
